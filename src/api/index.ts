...
export interface UserImageResponse {
  ...
  imageUrls: string[];
  /** Detailed information about each image */
  images: ImageDetails[];
 ...
 */
export type CreateNftMetadataDtoChain =
  (typeof CreateNftMetadataDtoChain)[keyof typeof CreateNftMetadataDtoChain];
 ...
 */
export type NftMetadataResponseChain =
  (typeof NftMetadataResponseChain)[keyof typeof NftMetadataResponseChain];
...
export const getRunpodControllerGetEndpointHealthQueryOptions = <
  TData = Awaited<ReturnType<typeof runpodControllerGetEndpointHealth>>,
  TError = void
>(options?: {
  query?: Partial<
    UseQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getRunpodControllerGetEndpointHealthQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof runpodControllerGetEndpointHealth>>
  > = ({ signal }) => runpodControllerGetEndpointHealth(requestOptions, signal);
...
export type RunpodControllerGetEndpointHealthQueryResult = NonNullable<
  Awaited<ReturnType<typeof runpodControllerGetEndpointHealth>>
>;
export type RunpodControllerGetEndpointHealthQueryError = void;

export function useRunpodControllerGetEndpointHealth<
  TData = Awaited<ReturnType<typeof runpodControllerGetEndpointHealth>>,
  TError = void
>(
  options: {
...
>(
  ...
  const queryOptions =
    getRunpodControllerGetEndpointHealthQueryOptions(options);
...
export const getRunpodControllerIsEndpointRunningQueryOptions = <
  TData = Awaited<ReturnType<typeof runpodControllerIsEndpointRunning>>,
  TError = void
>(options?: {
  query?: Partial<
    UseQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getRunpodControllerIsEndpointRunningQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof runpodControllerIsEndpointRunning>>
  > = ({ signal }) => runpodControllerIsEndpointRunning(requestOptions, signal);
...
export type RunpodControllerIsEndpointRunningQueryResult = NonNullable<
  Awaited<ReturnType<typeof runpodControllerIsEndpointRunning>>
>;
export type RunpodControllerIsEndpointRunningQueryError = void;

export function useRunpodControllerIsEndpointRunning<
  TData = Awaited<ReturnType<typeof runpodControllerIsEndpointRunning>>,
  TError = void
>(
  options: {
...
>(
  ...
  const queryOptions =
    getRunpodControllerIsEndpointRunningQueryOptions(options);
...
export const getRunpodControllerWakeUpEndpointMutationOptions = <
  TError = void,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type RunpodControllerWakeUpEndpointMutationResult = NonNullable<
  Awaited<ReturnType<typeof runpodControllerWakeUpEndpoint>>
>;
 ...
 * @summary Wake up the RunPod endpoint
 */
export const useRunpodControllerWakeUpEndpoint = <
  TError = void,
  TContext = unknown
>(
  options?: {
...
> => {
  const mutationOptions =
    getRunpodControllerWakeUpEndpointMutationOptions(options);
...
export const userControllerGetImagesByWalletAddress = (
  walletAddress: string,
  options?: SecondParameter<typeof getAxiosInstance>,
  signal?: AbortSignal
) => {
  return getAxiosInstance<UserImageResponse>(
    { url: `/api/user/${walletAddress}/images`, method: 'GET', signal },
    options
  );
};

export const getUserControllerGetImagesByWalletAddressQueryKey = (
  walletAddress: string
) => {
  return [`/api/user/${walletAddress}/images`] as const;
};

export const getUserControllerGetImagesByWalletAddressQueryOptions = <
  TData = Awaited<ReturnType<typeof userControllerGetImagesByWalletAddress>>,
  TError = unknown
>(
  walletAddress: string,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof userControllerGetImagesByWalletAddress>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    ...
    getUserControllerGetImagesByWalletAddressQueryKey(walletAddress);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof userControllerGetImagesByWalletAddress>>
  > = ({ signal }) =>
    userControllerGetImagesByWalletAddress(
      walletAddress,
      requestOptions,
      signal
    );
...
export type UserControllerGetImagesByWalletAddressQueryResult = NonNullable<
  Awaited<ReturnType<typeof userControllerGetImagesByWalletAddress>>
>;
export type UserControllerGetImagesByWalletAddressQueryError = unknown;

export function useUserControllerGetImagesByWalletAddress<
  TData = Awaited<ReturnType<typeof userControllerGetImagesByWalletAddress>>,
  TError = unknown
>(
  walletAddress: string,
...
>(
  ...
  const queryOptions = getUserControllerGetImagesByWalletAddressQueryOptions(
    walletAddress,
    options
  );
...
export const getNftControllerCreateNftMetadataMutationOptions = <
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type NftControllerCreateNftMetadataMutationResult = NonNullable<
  Awaited<ReturnType<typeof nftControllerCreateNftMetadata>>
>;
...
export const useNftControllerCreateNftMetadata = <
  TError = unknown,
  TContext = unknown
>(
  options?: {
...
> => {
  const mutationOptions =
    getNftControllerCreateNftMetadataMutationOptions(options);
